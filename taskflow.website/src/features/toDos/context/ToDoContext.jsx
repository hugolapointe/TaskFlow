...
import { SUCCESS_MESSAGES, ERROR_MESSAGES } from '../constants/toDoConstants';
import { updateItemInList, removeItemFromList, prependItemToList } from '@utils/listHelpers';
import { showConfirmDialog } from '@common/feedback/ConfirmDialog';
...
export const ToDoProvider = ({ children }) => {
    ...
    const archiveTodo = async (id) => {
        const confirmed = await showConfirmDialog({
            title: 'Archive Task',
            message: 'Are you sure you want to archive this task? This action cannot be undone.',
            confirmText: 'Archive',
            cancelText: 'Cancel',
            variant: 'danger',
        });
